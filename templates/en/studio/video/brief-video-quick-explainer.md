...
Create a BRIEF video for [TARGET AUDIENCE: data engineers with 2+ years experience].

Focus on:
- The single most important takeaway
- One actionable recommendation
- Key visual: [architecture diagram / comparison table / process flow]

Style: Direct, no fluff, assume technical baseline.
Exclude: Obvious definitions, generic introductions.
```

## Use Case (Data Engineering)

Quick intro à un concept pour onboarding nouveau dev.
